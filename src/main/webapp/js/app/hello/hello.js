require(["app/basic/basic", "helloEX"], function (basic, helloEX) {
    ...
    //3.test alert
    /*
    basicJs.showTip("testTip", 100);
    basicJs.showAlert("testAlert");
    basicJs.showIframe("testIframe", "testIframe");

    var alertContent = '<div class="protocol">\
       <h3 align="center">用户注册协议</h3>\
      </div>';
    var successContent = "恭喜";
    basicJs.showProtocol(alertContent, successContent, function () {
        console.log("im test doCallSuccess");
    });
    */


    //4.test location
    // basicJs.windowLoaction("https://www.baidu.com");
    basicJs.printf("okokokok");
